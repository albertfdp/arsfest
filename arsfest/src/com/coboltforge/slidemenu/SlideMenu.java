...
public class SlideMenu extends LinearLayout {
	...
	private static class SlideMenuAdapter extends ArrayAdapter<SlideMenuItem> {
		...
		public SlideMenuAdapter(Activity act, SlideMenuItem[] items,
				Typeface itemFont) {
			super(act, dk.dtu.arsfest.R.id.menu_label, items);
			this.act = act;
			this.items = items;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (rowView == null) {
				...
				rowView = inflater.inflate(
						dk.dtu.arsfest.R.layout.slidemenu_listitem, null);
				MenuItemHolder viewHolder = new MenuItemHolder();
				viewHolder.label = (TextView) rowView
						.findViewById(dk.dtu.arsfest.R.id.menu_label);
				if (itemFont != null)
					viewHolder.label.setTypeface(itemFont);
				viewHolder.icon = (ImageView) rowView
						.findViewById(dk.dtu.arsfest.R.id.menu_icon);
	...
	private void show(boolean animate) {
		 ...
		 * && menuWasShown) content.setX(menuSize);
		 */
		...
		menu = inflater.inflate(dk.dtu.arsfest.R.layout.slidemenu, null);
		...
		ListView list = (ListView) act
				.findViewById(dk.dtu.arsfest.R.id.menu_listview);
		...
		menu.findViewById(dk.dtu.arsfest.R.id.overlay).setOnClickListener(
				new OnClickListener() {
					@Override
