...
public class SideNavigation {
	...
	public SideNavigation(SideNavigationView sideNavigationView, Context context) {
		...
		sideNavigationView.setMenuClickCallback(new ISideNavigationCallback() {
			...
			public void onSideNavigationItemClick(int itemId) {
				...
				case R.id.side_navigation_map:
					...
					break;
				/*
				 * case R.id.side_navigation_old_events: intent = new
				 * Intent(mContext, MainActivity.class);
				 * intent.putExtra(Constants.EXTRA_EVENT_SHOW_FINISHED, true);
				 * break; case R.id.side_navigation_tickets: intent = new
				 * Intent(mContext, TicketSaleActivity.class);
